...
export const searchSchema = z.object({
  mode: z.enum(["business", "intent"]).default("business"),
  sources: z.array(z.enum(["freelance", "jobs", "communities", "social"])).default([]),
  keyword: z
    .string()
    .trim()
...
export const leadQuerySchema = z.object({
  ...
  phoneStatus: z.enum(["any", "valid", "invalid", "unknown", "not_checked"]).default("any"),
  sourceType: z.enum(["any", "intent_post", "website_analysis", "search_result"]).default("any"),
  leadStatus: z
    .enum([
