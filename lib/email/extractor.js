import { isPlatformEmail } from "../crawler/platforms";
...
export function isUsableEmail(email) {
  ...
  // support-in@google.com on a YouTube page is Google's address, not a lead's.
  if (isPlatformEmail(email)) return false;
  return true;
}
